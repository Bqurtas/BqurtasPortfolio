...
window.BQ_LOCAL_SEO_I18N = {
  en: {
    "meta.title.design":"Graphic Designer in Erbil, Kurdistan | Barakat Qurtas",
    "local.eye":"Erbil · Kurdistan · Iraq",
    "local.title":"A Kurdish graphic designer for brands that need to be remembered.",
    "local.lede":"Barakat Qurtas is an independent graphic and motion designer based in Erbil (Hewlêr), Kurdistan Region of Iraq. He builds clear brand identities, logos, editorial systems, printed matter, campaigns and motion work for clients in Kurdistan, across Iraq and internationally.",
    "local.area.title":"Based in Erbil, working everywhere","local.area.body":"Local knowledge for Hewlêr and Kurdistan, with remote collaboration across Iraq, the Middle East and beyond.",
    "local.services.title":"Identity, print and motion","local.services.body":"Logo and brand identity design, editorial and book design, posters, advertising, social campaigns, photography, video and motion graphics.",
    "local.languages.title":"Kurdish, Arabic and English","local.languages.body":"Bilingual and multilingual design that respects Kurdish, Arabic and Latin scripts instead of treating one as an afterthought.",
    "local.faq.eye":"Common questions","local.faq.title":"Looking for a graphic designer in Erbil?",
    "local.q1":"Who is Barakat Qurtas?","local.a1":"Barakat Qurtas is a Kurdish graphic and motion designer in Erbil with more than a decade of experience and over 1,000 completed works since 2014.",
    "local.q2":"What graphic design services are available?","local.a2":"Brand identity, logo design, books and editorial layouts, posters, print production, advertising campaigns, social media, photography, video editing and motion graphics.",
    "local.q3":"Do you work outside Erbil and Kurdistan?","local.a3":"Yes. Projects are available throughout Kurdistan and Iraq, with remote collaboration for clients across the Middle East and worldwide.",
    "local.q4":"How can I hire Barakat Qurtas?","local.a4":"Send the project type, goals, timeline and budget through the contact page. Serious enquiries receive a reply within 48 hours.","local.contact":"Start a project"
  },
  ku: {
    "meta.title.design":"دیزاینەری گرافیک لە هەولێر و کوردستان | بەرەکات قورتاس",
    "local.eye":"هەولێر · کوردستان · عێراق",
    "local.title":"دیزاینەرێکی گرافیکی کورد بۆ ئەو براندانەی دەیانەوێت لەبیر نەچن.",
    "local.lede":"بەرەکات قورتاس دیزاینەرێکی سەربەخۆی گرافیک و مۆشنە لە هەولێر، هەرێمی کوردستانی عێراق. ناسنامەی براند، لۆگۆ، سیستەمی ئەدیتۆریاڵ، چاپەمەنی، کەمپەین و مۆشن بۆ کڕیارانی کوردستان، عێراق و دەرەوە دروست دەکات.",
    "local.area.title":"لە هەولێرە، بۆ هەموو شوێنێک کار دەکات","local.area.body":"شارەزایی ناوخۆی هەولێر و کوردستان، لەگەڵ هاوکاریی دوورەوە لە سەرانسەری عێراق، ڕۆژهەڵاتی ناوەڕاست و جیهان.",
    "local.services.title":"ناسنامە، چاپ و مۆشن","local.services.body":"دیزاینی لۆگۆ و ناسنامەی براند، ئەدیتۆریاڵ و کتێب، پۆستەر، بانگەشە، کەمپەینی سۆشیاڵ، وێنەگرافی، ڤیدیۆ و موشن گرافیک.",
    "local.languages.title":"کوردی، عەرەبی و ئینگلیزی","local.languages.body":"دیزاینی دووزمانی و چەندزمانی کە ڕێز لە پیتی کوردی، عەرەبی و لاتینی دەگرێت و هیچ کامیان بە لاوەکی ناگرێت.",
    "local.faq.eye":"پرسیارە باوەکان","local.faq.title":"بە دوای دیزاینەری گرافیک لە هەولێر دەگەڕێیت؟",
    "local.q1":"بەرەکات قورتاس کێیە؟","local.a1":"بەرەکات قورتاس دیزاینەرێکی کوردی گرافیک و مۆشنە لە هەولێر؛ زیاتر لە دە ساڵ ئەزموون و زیاتر لە ١٠٠٠ کاری تەواوکراوی هەیە لە ساڵی ٢٠١٤ەوە.",
    "local.q2":"چ خزمەتگوزارییەکی دیزاینی گرافیک بەردەستە؟","local.a2":"ناسنامەی براند، لۆگۆ، کتێب و لاپەڕەسازی، پۆستەر، چاپ، کەمپەینی بانگەشە، سۆشیاڵ میدیا، وێنەگرافی، دەستکاری ڤیدیۆ و موشن گرافیک.",
    "local.q3":"لە دەرەوەی هەولێر و کوردستان کار دەکەیت؟","local.a3":"بەڵێ. پڕۆژە لە سەرانسەری کوردستان و عێراق وەردەگیرێت، هاوکاریی دوورەوەش بۆ کڕیارانی ڕۆژهەڵاتی ناوەڕاست و جیهان بەردەستە.",
    "local.q4":"چۆن بەرەکات قورتاس بەکاربهێنم؟","local.a4":"جۆری پڕۆژە، ئامانج، ماوە و بودجە لە پەڕەی پەیوەندی بنێرە. لە ماوەی ٤٨ کاتژمێردا وەڵامی داواکارییە جددییەکان دەدرێتەوە.","local.contact":"دەستپێکردنی پڕۆژە"
  },
  kmr: {
    "meta.title.design":"Sêwirmendê Grafîk li Hewlêr û Kurdistanê | Barakat Qurtas","local.eye":"Hewlêr · Kurdistan · Iraq","local.title":"Sêwirmendekî grafîk ê Kurd ji bo brandên ku dixwazin bên bîranîn.","local.lede":"Barakat Qurtas sêwirmendekî grafîk û tevgerê yê serbixwe ye li Hewlêrê, Herêma Kurdistanê ya Iraqê. Ew nasnameya brandê, logo, edîtoryal, çap, kampanya û motion ji bo mişteriyên Kurdistan, Iraq û derveyî çêdike.",
    "local.area.title":"Li Hewlêrê ye, li her derê dixebite","local.area.body":"Zanîna herêmî ya Hewlêr û Kurdistanê, bi hevkariya dûr ji Iraq, Rojhilata Navîn û cîhanê.","local.services.title":"Nasname, çap û motion","local.services.body":"Logo û nasnameya brandê, edîtoryal û pirtûk, poster, reklam, medya civakî, wênekêşî, montaja vîdyoyê û motion graphics.","local.languages.title":"Kurdî, erebî û îngilîzî","local.languages.body":"Sêwirana duzimanî û pirzimanî ku rêzê li nivîsên kurdî, erebî û latînî digire.",
    "local.faq.eye":"Pirsên gelemperî","local.faq.title":"Li sêwirmendekî grafîk li Hewlêrê digerî?","local.q1":"Barakat Qurtas kî ye?","local.a1":"Barakat Qurtas sêwirmendekî grafîk û tevgerê yê Kurd e li Hewlêrê, ji 2014 ve zêdetirî deh sal ezmûn û 1,000+ karên qedandî hene.","local.q2":"Kîjan xizmetên sêwirana grafîk hene?","local.a2":"Nasnameya brandê, logo, pirtûk û edîtoryal, poster, çap, reklam, medya civakî, wênekêşî, montaja vîdyoyê û motion graphics.","local.q3":"Li derveyî Hewlêr û Kurdistanê dixebitî?","local.a3":"Erê. Proje li seranserê Kurdistan û Iraqê, û bi dûr ji Rojhilata Navîn û cîhanê tên qebûlkirin.","local.q4":"Ez çawa dikarim Barakat Qurtas bixebitînim?","local.a4":"Cureya projeyê, armanc, dem û budceya xwe ji rûpela têkiliyê bişîne. Di 48 saetan de bersiv tê dayîn.","local.contact":"Projeyê dest pê bike"
  },
  ar: {
    "meta.title.design":"مصمم جرافيك في أربيل وكردستان | بركات قرطاس","local.eye":"أربيل · كردستان · العراق","local.title":"مصمم جرافيك كردي للعلامات التي تريد أن تُذكر.","local.lede":"بركات قرطاس مصمم جرافيك وموشن مستقل مقيم في أربيل، إقليم كردستان العراق. يصمم هويات بصرية وشعارات وأنظمة تحريرية ومطبوعات وحملات وموشن لعملاء في كردستان والعراق وخارجهما.",
    "local.area.title":"مقيم في أربيل، يعمل في كل مكان","local.area.body":"معرفة محلية بأربيل وكردستان، وتعاون عن بُعد في العراق والشرق الأوسط والعالم.","local.services.title":"هوية وطباعة وموشن","local.services.body":"تصميم الشعارات والهويات، الكتب والتحرير، الملصقات، الإعلان، حملات التواصل، التصوير، المونتاج والموشن جرافيك.","local.languages.title":"الكردية والعربية والإنجليزية","local.languages.body":"تصميم ثنائي ومتعدد اللغات يحترم الخطوط الكردية والعربية واللاتينية دون أن يجعل إحداها فكرة لاحقة.",
    "local.faq.eye":"أسئلة شائعة","local.faq.title":"هل تبحث عن مصمم جرافيك في أربيل؟","local.q1":"من هو بركات قرطاس؟","local.a1":"بركات قرطاس مصمم جرافيك وموشن كردي في أربيل، بخبرة تتجاوز عشر سنوات وأكثر من ١٠٠٠ عمل مكتمل منذ ٢٠١٤.","local.q2":"ما خدمات التصميم المتاحة؟","local.a2":"الهوية البصرية، الشعارات، الكتب والتصميم التحريري، الملصقات، الطباعة، الحملات الإعلانية، التواصل الاجتماعي، التصوير، المونتاج والموشن جرافيك.","local.q3":"هل تعمل خارج أربيل وكردستان؟","local.a3":"نعم. تُقبل المشاريع من جميع أنحاء كردستان والعراق، مع تعاون عن بُعد لعملاء الشرق الأوسط والعالم.","local.q4":"كيف أوظف بركات قرطاس؟","local.a4":"أرسل نوع المشروع والأهداف والمدة والميزانية عبر صفحة التواصل. تُجاب الاستفسارات الجدية خلال ٤٨ ساعة.","local.contact":"ابدأ مشروعاً"
  },
  tr: {
    "meta.title.design":"Erbil ve Kürdistan Grafik Tasarımcısı | Barakat Qurtas","local.eye":"Erbil · Kürdistan · Irak","local.title":"Hatırlanmak isteyen markalar için Kürt grafik tasarımcı.","local.lede":"Barakat Qurtas, Irak Kürdistan Bölgesi Erbil'de yaşayan bağımsız grafik ve hareket tasarımcısıdır. Kürdistan, Irak ve uluslararası müşteriler için marka kimliği, logo, editoryal sistem, baskı, kampanya ve hareketli tasarım üretir.",
    "local.area.title":"Erbil'de, her yerde çalışıyor","local.area.body":"Erbil ve Kürdistan'a dair yerel bilgi; Irak, Orta Doğu ve dünyanın her yeriyle uzaktan iş birliği.","local.services.title":"Kimlik, baskı ve hareket","local.services.body":"Logo ve marka kimliği, kitap ve editoryal tasarım, afiş, reklam, sosyal kampanya, fotoğraf, video kurgusu ve motion grafik.","local.languages.title":"Kürtçe, Arapça ve İngilizce","local.languages.body":"Kürtçe, Arapça ve Latin yazılarını sonradan eklenmiş gibi değil, eşit özenle ele alan çok dilli tasarım.",
    "local.faq.eye":"Sık sorulanlar","local.faq.title":"Erbil'de grafik tasarımcı mı arıyorsunuz?","local.q1":"Barakat Qurtas kimdir?","local.a1":"Barakat Qurtas, Erbil'de yaşayan Kürt grafik ve hareket tasarımcısıdır; 2014'ten beri on yılı aşkın deneyime ve 1.000'den fazla tamamlanmış işe sahiptir.","local.q2":"Hangi grafik tasarım hizmetleri var?","local.a2":"Marka kimliği, logo, kitap ve editoryal tasarım, afiş, baskı, reklam kampanyaları, sosyal medya, fotoğraf, video kurgu ve motion grafik.","local.q3":"Erbil ve Kürdistan dışında çalışıyor musunuz?","local.a3":"Evet. Kürdistan ve Irak genelinde, ayrıca Orta Doğu ve dünya çapında uzaktan projeler kabul edilir.","local.q4":"Barakat Qurtas ile nasıl çalışabilirim?","local.a4":"Proje türünü, hedefleri, süreyi ve bütçeyi iletişim sayfasından gönderin. Ciddi talepler 48 saat içinde yanıtlanır.","local.contact":"Proje başlat"
  },
  fr: {
    "meta.title.design":"Designer graphique à Erbil, Kurdistan | Barakat Qurtas","local.eye":"Erbil · Kurdistan · Irak","local.title":"Un designer graphique kurde pour les marques que l'on retient.","local.lede":"Barakat Qurtas est un designer graphique et motion indépendant basé à Erbil, au Kurdistan irakien. Il conçoit identités, logos, systèmes éditoriaux, imprimés, campagnes et motion pour le Kurdistan, l'Irak et l'international.","local.area.title":"Basé à Erbil, actif partout","local.area.body":"Une connaissance locale d'Erbil et du Kurdistan, avec collaboration à distance en Irak, au Moyen-Orient et ailleurs.","local.services.title":"Identité, print et motion","local.services.body":"Identité visuelle, logo, édition, livres, affiches, publicité, réseaux sociaux, photographie, vidéo et motion design.","local.languages.title":"Kurde, arabe et anglais","local.languages.body":"Un design multilingue qui respecte les écritures kurde, arabe et latine.","local.faq.eye":"Questions fréquentes","local.faq.title":"Vous cherchez un designer graphique à Erbil ?","local.q1":"Qui est Barakat Qurtas ?","local.a1":"Barakat Qurtas est un designer graphique et motion kurde à Erbil, avec plus de dix ans d'expérience et plus de 1 000 travaux depuis 2014.","local.q2":"Quels services sont proposés ?","local.a2":"Identité, logos, édition, livres, affiches, impression, publicité, réseaux sociaux, photo, montage vidéo et motion.","local.q3":"Travaillez-vous hors d'Erbil et du Kurdistan ?","local.a3":"Oui, dans tout le Kurdistan et l'Irak, ainsi qu'à distance au Moyen-Orient et dans le monde.","local.q4":"Comment travailler avec Barakat Qurtas ?","local.a4":"Envoyez le type de projet, les objectifs, le délai et le budget via la page contact. Réponse sous 48 h.","local.contact":"Lancer un projet"
  },
  sv: {
    "meta.title.design":"Grafisk designer i Erbil, Kurdistan | Barakat Qurtas","local.eye":"Erbil · Kurdistan · Irak","local.title":"En kurdisk grafisk designer för varumärken som ska bli ihågkomna.","local.lede":"Barakat Qurtas är en oberoende grafisk och motion-designer i Erbil, irakiska Kurdistan. Han skapar identiteter, logotyper, redaktionella system, tryck, kampanjer och motion för kunder lokalt och internationellt.","local.area.title":"Baserad i Erbil, arbetar överallt","local.area.body":"Lokal kunskap om Erbil och Kurdistan med distanssamarbete i Irak, Mellanöstern och världen.","local.services.title":"Identitet, tryck och motion","local.services.body":"Varumärkesidentitet, logo, böcker, redaktionellt, affischer, reklam, sociala kampanjer, foto, video och motion graphics.","local.languages.title":"Kurdiska, arabiska och engelska","local.languages.body":"Flerspråkig design som respekterar kurdiska, arabiska och latinska skriftsystem.","local.faq.eye":"Vanliga frågor","local.faq.title":"Söker du en grafisk designer i Erbil?","local.q1":"Vem är Barakat Qurtas?","local.a1":"Barakat Qurtas är en kurdisk grafisk och motion-designer i Erbil med över tio års erfarenhet och 1 000+ arbeten sedan 2014.","local.q2":"Vilka designtjänster finns?","local.a2":"Identitet, logo, böcker, redaktionellt, affischer, tryck, reklam, sociala medier, foto, videoredigering och motion graphics.","local.q3":"Arbetar du utanför Erbil och Kurdistan?","local.a3":"Ja, i hela Kurdistan och Irak samt på distans i Mellanöstern och världen.","local.q4":"Hur anlitar jag Barakat Qurtas?","local.a4":"Skicka projekttyp, mål, tidsplan och budget via kontaktsidan. Seriösa förfrågningar besvaras inom 48 timmar.","local.contact":"Starta ett projekt"
  }
};
...
window.I18N_EXTRA_B = {
 "en": {
  ...
  "bp.quote": "“Wherever I work — now or later — what matters is that the work earns trust and leaves people glad they asked.”",
  ...
  "ex1.title": "Designer at Directorate of Media Affairs",
  ...
  "ex1.more": "+16 skills",
  "ex2.title": "Former designer at Protocol Media",
 ...
 "ku": {
  ...
  "bp.quote": "«لە هەر شوێنێک کار بکەم — ئێستا یان دواتر — گرنگ ئەوەیە کارەکە متمانە بهێنێت و خەڵک دڵخۆش بن کە داوایان کردووە.»",
