...
window.I18N = {
  ...
  ku: {
    ...
    'contact.submit': 'نامەکە بنێرە',
        ...
        'meta.title.design': 'بەرکەت قورتاس — دیزاینەری گرافیک و مۆشن',
    'meta.title.blog': 'گۆڤار — بەرکەت قورتاس', 'meta.title.bio': 'بایۆگرافی — بەرکەت قورتاس', 'meta.title.contact': 'پەیوەندی — بەرکەت قورتاس',
  ...
  ar: {
    ...
    'contact.submit': 'أرسل الاقتراح',
        ...
        'meta.title.design': 'بركات قرتاس — مصمم جرافيك وموشن كردي',
    'meta.title.blog': 'المدونة — بركات قرتاس', 'meta.title.bio': 'السيرة — بركات قرتاس', 'meta.title.contact': 'التواصل — بركات قرتاس',
...
window.TAB_META_I18N = {
  ...
  ku: {
    all:      { title: 'هەموو کارەکان', desc: 'کاتالۆگی تەواو — هەموو پیشەیەک، یەک پراکتیک.',                 note: 'لەلایەن بەرکەت قورتاس · هەولێر، کوردستان' },
  ...
  ar: {
    all:      { title: 'كل الأعمال',     desc: 'الكتالوج الكامل — كل تخصص، ممارسة واحدة.',                 note: 'بقلم بركات قرتاس · أربيل، كردستان' },
...
window.I18N_EXTRA_B = {
 ...
 "ku": {
  ...
  "bp.p1": "من بەرکەت قورتاسم، لە سۆران لەدایکبووم و ئێستا لە هەولێر نیشتەجێم — شارێک کە شێوازی بینینم بۆ جیهان گۆڕی. لە نێوان بێدەنگیی چیاکان و ڕیتمی ژیانی شار گەورەبووم — دوو دژایەتی کە هەتا ئێستا زمانی دیزاینم دیاری دەکەن. هەولێر ئێستا شەوگاری درەوشاوە و ئیلهامی بێکۆتایی پێشکەش دەکات.",
 ...
 "ar": {
  "bio.lede": "<span class=\"dropcap\">ب</span>ركات قرتاس بابكر — مصمم جرافيك مستقل، يعمل بين البروتوكول الرسمي والتصميم التحريري والمشاريع الشخصية الهادئة. مقيم في أربيل، إقليم كردستان العراق.",
  ...
  "bp.p1": "أنا بركات قرتاس، وُلدت في سوران وأقيم حاليًا في أربيل — مدينة غيّرت طريقة رؤيتي للعالم. نشأت بين سكون الجبال وإيقاع حياة المدينة — تناقضان ما زالا يحددان لغتي التصميمية. أربيل الآن تمنحني ليالي متوهجة وإلهامًا لا ينتهي.",
...
window.CHAT_I18N = {"ku": {"greet": "سڵاو! 👋 من یاریدەدەری ستۆدیۆم. چۆن یارمەتیت بدەم — <b>خزمەتگوزاری</b>، <b>نرخ</b>، یان دەستپێکردنی <b>پڕۆژە</b>؟", "fallback": "دڵنیا نیم لەوە — بەڵام بەرکەت ڕاستەوخۆ یارمەتیت دەدات. ژووری <b>پەیوەندی</b> تاقیبکەرەوە، یان پرسیارم لێبکە دەربارەی <i>خزمەتگوزاری، نرخ، کات، یان زمانەکان</i>.", "quick": [{"label": "خزمەتگوزاری", "q": "خزمەت"}, {"label": "نرخ", "q": "نرخ"}, {"label": "کات", "q": "کات"}, {"label": "پەیوەندی", "q": "پەیوەندی"}], "kb": [{"k": ["خزمەت", "خزمەتگوزاری", "چی دەکەی", "پێشکەش"], "a": "من پێشکەشی <b>ناسنامەی بران و دیزاینی لۆگۆ</b>، <b>ئەدیتۆریاڵ و بەرگی کتێب</b>، <b>پۆستەر</b>، <b>سۆشیال میدیا</b>، <b>چاپ و پسووڵە</b>، و <b>مۆنتاژی ڤیدیۆ</b> دەکەم. دەتەوێت بەشێک ببینیت؟ تابەکانی ژووری دیزاین تاقیبکەرەوە."}, {"k": ["نرخ", "چەند", "بودجە", "تێچوو"], "a": "نرخ بەپێی قەبارە دەگۆڕێت. خاڵی دەستپێک:<br>• <b>لۆگۆ</b> — لە ٣٠٠$<br>• <b>ناسنامەی بران</b> — لە ٩٠٠$<br>• <b>بەرگی کتێب</b> — لە ٢٥٠$<br>• <b>پۆستەر</b> — لە ١٥٠$<br>بۆ نرخی وردتر، کورتەیەک بنێرە لە ژووری پەیوەندی."}, {"k": ["کات", "ماوە", "چەند دەخایەنێت", "کەی"], "a": "کاتە ئاساییەکان: لۆگۆ لە <b>١–٢ هەفتە</b>، ناسنامەی تەواو لە <b>٣–٥ هەفتە</b>، بەرگی کتێب لە <b>١ هەفتە</b>. کاری خێرا دەکرێت — کاتی کۆتاییت پێ بڵێ."}, {"k": ["پەیوەندی", "ئیمەیل", "تەلەفۆن", "واتساب", "دامەزراندن"], "a": "ئاسانترین ڕێگا بۆ پەیوەندی بە بەرکەت:<br>• ✉️ <a href='mailto:info@bqurtas.com'>info@bqurtas.com</a><br>• 📱 <a href='https://wa.me/9647517884985' target='_blank' rel='noopener'>WhatsApp +964 751 788 4985</a><br>یان ژووری <b>پەیوەندی</b> بکەرەوە و کورتەیەک بنێرە."}, {"k": ["کێیە", "دەربارە", "ئەزموون", "بەرکەت"], "a": "بەرکەت قورتاس دیزاینەری گرافیکی سەربەخۆیە لە <b>هەولێر، کوردستان</b>، لە <b>٢٠١٤</b>ـەوە — ئێستا لەگەڵ بەڕێوەبەرایەتیی کاروباری ڕاگەیاندن لە نووسینگەی سەرۆک. ١٠٠٠+ کار لە چاپ و دیجیتاڵ."}, {"k": ["زمان", "زمانەکان", "قسە"], "a": "بەرکەت بە <b>کوردی (سۆرانی و کرمانجی)</b>، <b>عەرەبی</b>، <b>ئینگلیزی</b>، و هەندێک <b>فەرەنسی</b> کار دەکات."}, {"k": ["کتێب", "بەرگ"], "a": "بەرگی کتێب تایبەتمەندییەکی منە — ٩٩ بەرگ و زیاتر. تابی <b>کتێب</b> لە ژووری دیزاین بکەرەوە."}, {"k": ["لۆگۆ", "بران", "ناسنامە"], "a": "لۆگۆ و ناسنامە خۆشەویستترین کارمن. تابی <b>لۆگۆ</b> ببینە، یان مۆرەکانی «بە دەست دیزاینکراو» لە پەڕەی سەرەکی."}, {"k": ["فەرمی", "حکوومەت", "سەرۆکایەتی"], "a": "ئەدیتۆریاڵی فەرمی بۆ سەرۆکایەتیی هەرێمی کوردستان دروست دەکەم — تابی <b>فەرمی</b> ببینە (١٦٨ کار)."}, {"k": ["سڵاو", "های", "سلاو"], "a": "سڵاو! 👋 من یاریدەدەری ستۆدیۆی بەرکەتم. پرسیارم لێبکە دەربارەی خزمەتگوزاری، نرخ، کات، یان دەستپێکردنی پڕۆژە."}, {"k": ["سوپاس", "زۆر سوپاس"], "a": "شایانی نییە! شتی تر هەیە بزانیت؟ 🙂"}]}, "ar": {"greet": "مرحبًا! 👋 أنا مساعد الاستوديو. كيف أساعدك — <b>الخدمات</b> أو <b>الأسعار</b> أو بدء <b>مشروع</b>؟", "fallback": "لست متأكدًا من ذلك — لكن بركات يساعدك مباشرة. جرّب غرفة <b>التواصل</b>، أو اسألني عن <i>الخدمات أو الأسعار أو الوقت أو اللغات</i>.", "quick": [{"label": "الخدمات", "q": "خدمات"}, {"label": "الأسعار", "q": "سعر"}, {"label": "الوقت", "q": "وقت"}, {"label": "تواصل", "q": "تواصل"}], "kb": [{"k": ["خدمات", "خدمة", "ماذا تفعل", "تقدم"], "a": "أقدّم <b>الهوية البصرية وتصميم الشعارات</b>، <b>التصميم التحريري وأغلفة الكتب</b>، <b>الملصقات</b>، <b>وسائل التواصل</b>، <b>الطباعة والفواتير</b>، و<b>مونتاج الفيديو</b>. تريد رؤية فئة؟ جرّب تبويبات غرفة التصميم."}, {"k": ["سعر", "الأسعار", "كم", "ميزانية", "تكلفة"], "a": "السعر يعتمد على الحجم. نقاط البداية:<br>• <b>شعار</b> — من ٣٠٠$<br>• <b>هوية بصرية</b> — من ٩٠٠$<br>• <b>غلاف كتاب</b> — من ٢٥٠$<br>• <b>ملصق</b> — من ١٥٠$<br>لعرض دقيق، أرسل موجزًا عبر غرفة التواصل."}, {"k": ["وقت", "مدة", "كم يستغرق", "متى", "موعد"], "a": "المدد المعتادة: شعار في <b>١–٢ أسبوع</b>، هوية كاملة في <b>٣–٥ أسابيع</b>، غلاف كتاب في <b>أسبوع</b>. العمل العاجل ممكن — أخبرني بموعدك."}, {"k": ["تواصل", "بريد", "هاتف", "واتساب", "توظيف"], "a": "أسهل طرق الوصول إلى بركات:<br>• ✉️ <a href='mailto:info@bqurtas.com'>info@bqurtas.com</a><br>• 📱 <a href='https://wa.me/9647517884985' target='_blank' rel='noopener'>WhatsApp +964 751 788 4985</a><br>أو افتح غرفة <b>التواصل</b> وأرسل موجزًا."}, {"k": ["من", "عن", "خبرة", "بركات"], "a": "بركات قرتاس مصمم جرافيك مستقل في <b>أربيل، كردستان</b>، يعمل منذ <b>٢٠١٤</b> — حاليًا مع مديرية الشؤون الإعلامية في مكتب الرئيس. أكثر من ١٠٠٠ عمل في الطباعة والرقمي."}, {"k": ["لغة", "لغات", "يتحدث"], "a": "يعمل بركات بـ<b>الكردية (سوراني وكرمانجي)</b>، <b>العربية</b>، <b>الإنجليزية</b>، وبعض <b>الفرنسية</b>."}, {"k": ["كتاب", "غلاف"], "a": "أغلفة الكتب تخصص — ٩٩ غلافًا وأكثر. افتح تبويب <b>الكتب</b> في غرفة التصميم."}, {"k": ["شعار", "هوية"], "a": "الشعارات والهويات عملي المفضل. شاهد تبويب <b>الشعارات</b>، أو علامات «مصمَّمة باليد» في الصفحة الرئيسية."}, {"k": ["رسمي", "حكومة", "رئاسة"], "a": "أصمّم محتوى تحريريًا رسميًا لرئاسة إقليم كردستان — شاهد تبويب <b>رسمي</b> (١٦٨ عملًا)."}, {"k": ["مرحبا", "أهلا", "سلام"], "a": "مرحبًا! 👋 أنا مساعد استوديو بركات. اسألني عن الخدمات أو الأسعار أو الوقت أو بدء مشروع."}, {"k": ["شكرا", "شكرًا"], "a": "على الرحب والسعة! هل من شيء آخر تريد معرفته؟ 🙂"}]}, "fr": {"greet": "Bonjour ! 👋 Je suis l'assistant du studio. Comment aider — <b>services</b>, <b>tarifs</b>, ou démarrer un <b>projet</b> ?", "fallback": "Je ne suis pas sûr — mais Barakat peut aider directement. Essayez la salle <b>Contact</b>, ou demandez-moi <i>services, tarifs, délais ou langues</i>.", "quick": [{"label": "Services", "q": "service"}, {"label": "Tarifs", "q": "prix"}, {"label": "Délais", "q": "délai"}, {"label": "Contact", "q": "contact"}], "kb": [{"k": ["service", "services", "que faites", "proposez"], "a": "Je propose <b>identité de marque & logos</b>, <b>édition & couvertures de livres</b>, <b>affiches</b>, <b>réseaux sociaux</b>, <b>impression & factures</b>, et <b>montage vidéo</b>. Voir une catégorie ? Essayez les onglets de la salle Design."}, {"k": ["prix", "tarif", "tarifs", "combien", "budget", "coût"], "a": "Le prix dépend de l'ampleur. Points de départ :<br>• <b>Logo</b> — dès 300 $<br>• <b>Identité de marque</b> — dès 900 $<br>• <b>Couverture</b> — dès 250 $<br>• <b>Affiche</b> — dès 150 $<br>Pour un devis exact, envoyez un brief via la salle Contact."}, {"k": ["délai", "délais", "temps", "combien de temps", "quand", "échéance"], "a": "Délais typiques : un logo en <b>1–2 semaines</b>, une identité complète en <b>3–5 semaines</b>, une couverture en <b>1 semaine</b>. L'urgence est possible — dites-moi votre échéance."}, {"k": ["contact", "email", "téléphone", "whatsapp", "embaucher"], "a": "Le plus simple pour joindre Barakat :<br>• ✉️ <a href='mailto:info@bqurtas.com'>info@bqurtas.com</a><br>• 📱 <a href='https://wa.me/9647517884985' target='_blank' rel='noopener'>WhatsApp +964 751 788 4985</a><br>Ou ouvrez la salle <b>Contact</b> et envoyez un brief."}, {"k": ["qui", "à propos", "expérience", "barakat"], "a": "Barakat Qurtas est designer graphique indépendant à <b>Erbil, Kurdistan</b>, depuis <b>2014</b> — actuellement à la Direction des affaires médiatiques au Cabinet du Président. Plus de 1000 travaux, imprimé & numérique."}, {"k": ["langue", "langues", "parle"], "a": "Barakat travaille en <b>kurde (sorani & kurmancî)</b>, <b>arabe</b>, <b>anglais</b>, et un peu de <b>français</b>."}, {"k": ["livre", "couverture"], "a": "Les couvertures de livres sont une spécialité — 99 et plus. Ouvrez l'onglet <b>Livre</b> dans la salle Design."}, {"k": ["logo", "marque", "identité"], "a": "Les logos et identités sont mon travail préféré. Voyez l'onglet <b>Logo</b>, ou les marques « dessinées à la main » sur la page d'accueil."}, {"k": ["officiel", "gouvernement", "présidence"], "a": "Je crée l'éditorial officiel pour la Présidence de la Région du Kurdistan — voyez l'onglet <b>Officiel</b> (168 travaux)."}, {"k": ["bonjour", "salut", "coucou"], "a": "Bonjour ! 👋 Je suis l'assistant de studio de Barakat. Demandez-moi services, tarifs, délais, ou comment démarrer un projet."}, {"k": ["merci"], "a": "Avec plaisir ! Autre chose que vous aimeriez savoir ? 🙂"}]}, "kmr": {"greet": "Slav! 👋 Ez alîkarê studyoyê me. Çawa alîkar bim — <b>karûbar</b>, <b>biha</b>, an destpêkirina <b>projeyek</b>?", "fallback": "Ne piştrast im — lê Barakat rasterast alîkar dike. Odeya <b>Têkilî</b> biceribîne, an ji min bipirse <i>karûbar, biha, dem, an ziman</i>.", "quick": [{"label": "Karûbar", "q": "karûbar"}, {"label": "Biha", "q": "biha"}, {"label": "Dem", "q": "dem"}, {"label": "Têkilî", "q": "têkilî"}], "kb": [{"k": ["karûbar", "karûbarên", "çi dikî", "pêşkêş"], "a": "Ez <b>nasnameya brandê & logo</b>, <b>edîtoriyal & bergên pirtûkan</b>, <b>poster</b>, <b>medya civakî</b>, <b>çap & fatûre</b>, û <b>montaja vîdyoyê</b> pêşkêş dikim. Dixwazî kategoriyekê bibînî? Tabên odeya Design biceribîne."}, {"k": ["biha", "çiqas", "bûdce", "mesref"], "a": "Biha li gorî mezinahiyê ye. Xalên destpêkê:<br>• <b>Logo</b> — ji 300$<br>• <b>Nasnameya brandê</b> — ji 900$<br>• <b>Bergê pirtûkê</b> — ji 250$<br>• <b>Poster</b> — ji 150$<br>Ji bo bihayeke rast, kurteyek bişîne odeya Têkilî."}, {"k": ["dem", "çiqas dem", "kengî", "wext"], "a": "Demên asayî: logo di <b>1–2 hefte</b>, nasnameyeke temam di <b>3–5 hefte</b>, bergê pirtûkê di <b>1 hefte</b> de. Karê bilez mimkun e — dema xwe ya dawî ji min re bêje."}, {"k": ["têkilî", "e-name", "telefon", "whatsapp", "kar"], "a": "Rêya herî hêsan ji bo gihîştina Barakat:<br>• ✉️ <a href='mailto:info@bqurtas.com'>info@bqurtas.com</a><br>• 📱 <a href='https://wa.me/9647517884985' target='_blank' rel='noopener'>WhatsApp +964 751 788 4985</a><br>An odeya <b>Têkilî</b> veke û kurteyek bişîne."}, {"k": ["kî", "derbarê", "ezmûn", "barakat"], "a": "Barakat Qurtas sêwirmendê grafîk ê serbixwe ye li <b>Hewlêr, Kurdistan</b>, ji <b>2014</b> — niha bi Bereyê Karûbarên Medyayê li Nivîsgeha Serok. 1000+ kar di çap û dîjîtal de."}, {"k": ["ziman", "zimanan", "diaxive"], "a": "Barakat bi <b>Kurdî (Soranî & Kurmancî)</b>, <b>Erebî</b>, <b>Îngilîzî</b>, û hinekî <b>Fransî</b> dixebite."}, {"k": ["pirtûk", "berg"], "a": "Bergên pirtûkan pisporî ne — 99 berg û zêdetir. Taba <b>Pirtûk</b> li odeya Design veke."}, {"k": ["logo", "brand", "nasname"], "a": "Logo û nasname karê min ê herî bijartî ne. Taba <b>Logo</b> bibîne, an nîşanên «bi dest» li rûpela malê."}, {"k": ["fermî", "hikûmet", "serokatî"], "a": "Ez edîtoriyala fermî ji bo Serokatiya Herêma Kurdistanê çêdikim — taba <b>Fermî</b> bibîne (168 kar)."}, {"k": ["slav", "silav", "merheba"], "a": "Slav! 👋 Ez alîkarê studyoya Barakat im. Ji min bipirse karûbar, biha, dem, an destpêkirina projeyê."}, {"k": ["spas", "gelek spas"], "a": "Bi xêr hatî! Tiştek din heye ku tu bixwazî bizanî? 🙂"}]}};
