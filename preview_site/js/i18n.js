...
window.I18N = {
  ...
  tr: {
    ...
    'meta.title.blog': 'Dergi — Barakat Kurtaş',
    'meta.title.contact': 'İletişim — Barakat Kurtaş',
    'meta.title.bio': 'Biyografi — Barakat Kurtaş',
    'meta.title.design': 'Barakat Kurtaş | Tasarım • Baskı • Reklam',
    'd.note': 'Kısa bir not',
    ...
    'opt.direct': 'Doğrudan',
    'bio.lede': '<span class="dropcap">Barakat Kurtas Babakr — devlet protokolü, editoryal tasarım ve sessiz kişisel projeler arasında çalışan bağımsız grafik tasarımcısı. Merkezi Irak\'ın Kürdistan Bölgesi Erbil\'de bulunmaktadır.',
    'bp.eye': 'Tasarımcının arkasındaki hikayeyi keşfedin',
    'bp.p1': 'Ben Barakat Kurtas, Soran\'da doğdum ve şu anda dünyaya bakış açımı değiştiren bir şehir olan Erbil\'de yaşıyorum. Dağların dinginliği ile şehir yaşamının ritmi arasında büyüdüm; tasarım dilimi tanımlamaya devam eden iki karşıtlık. Erbil artık ışıltılı geceler ve sonsuz ilham sunuyor.',
